...
@EnableBatchProcessing // 배치를 돌리기 위한 설정
@SpringBootApplication
public class PassBatchApplication {

    private JobBuilderFactory jobBuilderFactory; // job을 만들어줄수있는 builder

    private StepBuilderFactory stepBuilderFactory; //step을 만들어주는 builder
